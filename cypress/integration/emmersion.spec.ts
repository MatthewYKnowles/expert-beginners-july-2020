...
describe("Emmersion End to End Tests", () => {
    ...
    it.skip('not using page object: should create admin and see it in the admin list', () => {
        ...
        cy.visit('/')
        cy.get('[data-test=username]').type('local-holonet')
        cy.get('[data-test=password]').type('Testing1!')
        cy.get('[data-test=sign-in]').click();
        cy.get('[data-test=search]').type('Local');
        cy.get('[data-test="Local TN + WC-account"]').click();
    ...
    it('using page object: should create admin and see it in the admin list', () => {
